...
public class ServicioUsuario {
	...
	public boolean validar(String numerocontrol, String clave, HttpSession sesion)
	{
		Usuario usr= repoUsuario.validar(numerocontrol,encriptar(clave));
		if(usr !=null)
		{
			sesion.setAttribute("iduser", usr.getId());
			Mensaje = usr.getNombrecompleto()+ " - " + usr.getNumerocontrol();
			return true;
		}
